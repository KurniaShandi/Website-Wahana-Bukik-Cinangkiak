...
<head>
    ...
    <title>Print PDF - Laporan Penjualan</title>
    <style>
        body {
                ...
                <table class="table">
                    <thead>
                        <tr class="fw-bold fs-6 text-gray-800">
                            ...
                            <th class="min-w-100px text-center">Kode Pemesanan</th>
                            <th class="min-w-150px text-center">Jadwal</th>
                            <th class="min-w-150px text-center">Jumlah Tiket</th>
                            <th class="min-w-100px text-center">Total Bayar</th>
