...
<head>
    ...
    <title>Print PDF - Laporan Pengunjung</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="content">
            <div class="title">Laporan Pengunjung</div>
            <div class="section">
                <table class="table">
                    <thead>
                        <tr class="fw-bold fs-6 text-gray-800">
                            ...
                            <th class="min-w-100px text-center">Username</th>
                            <th class="min-w-100px text-center">Foto</th>
                            <th class="min-w-150px text-center">Alamat</th>
                        </tr>
                    </thead>
                    <tbody>
