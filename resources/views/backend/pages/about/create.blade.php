            ...
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="{{ route('store-about') }}" data-toggle="validator" method="post"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="url" name="link_youtube" class="form-control" required>
                                    @error('link_youtube')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="url" name="link_facebook" class="form-control" required>
                                    @error('link_facebook')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="url" name="link_instagram" class="form-control" required>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="url" name="link_email" class="form-control" required>
                                    @error('link_email')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="url" name="link_twitter" class="form-control" required>
                                    @error('link_twitter')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                </div>
