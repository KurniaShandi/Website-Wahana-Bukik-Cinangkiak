...
@section('contents')
    <div class="pagetitle">
        <h1>Data Jadwal Wahana</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
                <li class="breadcrumb-item active">Data Jadwal Wahana</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-end" style="margin-top: 20px;">
                            <a href="{{ route('create-jadwal-wahana') }}" class="btn btn-primary mb-3">Tambah Data</a>
                        </div>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <button type="button" class="btn btn-success btn-sm me-2" title="Edit"
                                                    onclick="window.location.href='{{ route('edit-jadwal-wahana', $data->id) }}'">
                                            ...
                                            <form id="deleteForm_{{ $data->id }}"
                                                action="{{ route('destroy-jadwal-wahana', $data->id) }}" method="POST" style="display:none;">
                                                @csrf
                                                @method('DELETE')
                                            </form>
                                            <script>
